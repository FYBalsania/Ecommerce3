$(document).ready(() => {
    const add_ValueModal = $('#add_ValueModal');
    add_ValueModal.on('shown.bs.modal', shown_AddValueView);
    add_ValueModal.on('hidden.bs.modal', hide_AddValueView);
...
function shown_AddValueView(event) {
    //Register event handlers.
    $('#add_ValueSave').on('click', add_ValueSaveClicked);
    $('#add_Value').on('change', add_ValueChanged);
}

async function add_ValueSaveClicked(event) {
    const value = $('#add_Value');
    const slug = $('#add_Slug');
    const display = $('#add_Display');
    const breadcrumb = $('#add_Breadcrumb');

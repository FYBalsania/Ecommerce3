...
public class EditProductViewModel
{
    ...
    public static EditProductViewModel FromDTO(ProductDTO productDTO)
    {
        return new EditProductViewModel
        {
            ...
            Breadcrumb = productDTO.Breadcrumb,
            AnchorText = productDTO.AnchorText,
            AnchorTitle = productDTO.AnchorTitle,
            ...
            AllowReviews = productDTO.AllowReviews,
            Price = productDTO.Price,
            OldPrice = productDTO.OldPrice,
            CostPrice = productDTO.CostPrice,
            Stock = productDTO.Stock,
            MinStock = productDTO.MinStock,
            ShowAvailability = productDTO.ShowAvailability,
            ...
            QuantityPerUnitOfMeasure = productDTO.QuantityPerUnitOfMeasure,
            DeliveryWindowId = productDTO.DeliveryWindowId,

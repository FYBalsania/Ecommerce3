...
public class AddProductAttributeTextValueViewModel
{
    ...
    public AddProductAttributeTextValueCommand ToCommand(int createdBy, DateTime createdAt, string createdByIp)
    {
        return new AddProductAttributeTextValueCommand
        {

...
public sealed class BankPage : Page
{
    ...
    public BankPage(string? path, string metaTitle, string? metaDescription, string? metaKeywords, string? metaRobots,
        ...
        bool isActive, int createdBy, DateTime createdAt, IPAddress createdByIp, Bank bank)

...
public sealed class CategoryPage : Page
{
    ...
    internal CategoryPage() : base()
    {
    }
    
    public CategoryPage(string? path, string metaTitle, string? metaDescription, string? metaKeywords,
        ...
        DateTime createdAt, IPAddress createdByIp, Category category)

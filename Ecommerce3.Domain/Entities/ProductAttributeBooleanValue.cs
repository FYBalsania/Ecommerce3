...
public sealed class ProductAttributeBooleanValue : ProductAttributeValue
{
    ...
    private ProductAttributeBooleanValue()
    {
    }
    ...
    public bool Update(string value, string slug, string display, string breadcrumb, int sortOrder, int updatedBy, string updatedByIp)
    {
        ValidateName(value);
        ValidateSlug(slug);

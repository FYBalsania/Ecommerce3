...
public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.Property(x => x.AverageRating).HasColumnType("decimal(3,2)").HasColumnOrder(19);
        ...
        builder.Property(x => x.Stock).HasColumnType("int").HasColumnOrder(24);
        builder.Property(x => x.MinStock).HasColumnType("int").HasColumnOrder(25);
        ...
        builder.Property(x => x.QuantityPerUnitOfMeasure).HasColumnType("decimal(18,4)").HasColumnOrder(30);
        builder.Property(x => x.DeliveryWindowId).HasColumnType("integer").HasColumnOrder(31);
        builder.Property(x => x.MinOrderQuantity).HasColumnType("int").HasColumnOrder(32);
        builder.Property(x => x.MaxOrderQuantity).HasColumnType("int").HasColumnOrder(33);

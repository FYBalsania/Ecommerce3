...
public class ProductCategoryConfiguration : IEntityTypeConfiguration<ProductCategory>
{
    public void Configure(EntityTypeBuilder<ProductCategory> builder)
    {
        ...
        builder.HasIndex(x => x.CreatedAt).HasDatabaseName($"idx_product_category_created_at");
        builder.HasIndex(x => x.DeletedAt).HasDatabaseName($"idx_product_category_deleted_at");

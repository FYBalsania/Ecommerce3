...
public class TextListItemConfiguration : IEntityTypeConfiguration<TextListItem>
{
    public void Configure(EntityTypeBuilder<TextListItem> builder)
    {
        ...
        builder.HasIndex(x => x.CreatedAt).HasDatabaseName($"idx_text_list_item_created_at");
        builder.HasIndex(x => x.DeletedAt).HasDatabaseName($"idx_text_list_item_deleted_at");

...
public class CategoryConfiguration : IEntityTypeConfiguration<Category>
{
    public void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.Property(x => x.GoogleCategory).HasMaxLength(1024).HasColumnType("varchar(1024)").HasColumnOrder(8);
        builder.Property(x => x.MetaTitle).HasMaxLength(256).HasColumnType("varchar(256)").HasColumnOrder(9);
        builder.Property(x => x.MetaDescription).HasMaxLength(1024).HasColumnType("varchar(1024)").HasColumnOrder(10);
        builder.Property(x => x.MetaKeywords).HasMaxLength(1024).HasColumnType("varchar(1024)").HasColumnOrder(11);
        builder.Property(x => x.H1).HasMaxLength(256).HasColumnType("varchar(256)").HasColumnOrder(12);
        builder.Property(x => x.ParentId).HasColumnType("integer").HasColumnOrder(13);
        builder.Property(x => x.Path).HasColumnType("ltree").HasColumnOrder(14);
        builder.Property(x => x.ShortDescription).HasMaxLength(512).HasColumnType("varchar(512)").HasColumnOrder(15);
        builder.Property(x => x.FullDescription).HasColumnType("text").HasColumnOrder(16);
        builder.Property(x => x.IsActive).HasColumnType("boolean").HasColumnOrder(17);

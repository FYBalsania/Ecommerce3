...
public class PageConfiguration : IEntityTypeConfiguration<Page>
{
    public void Configure(EntityTypeBuilder<Page> builder)
    {
        ...
        builder.Property(x => x.MetaTitle).HasMaxLength(256).HasColumnType("varchar(256)").HasColumnOrder(13);
        ...
        builder.Property(x => x.CanonicalUrl).HasMaxLength(2048).HasColumnType("varchar(2048)").HasColumnOrder(17);
        ...
        builder.Property(x => x.H1).HasMaxLength(256).HasColumnType("varchar(256)").HasColumnOrder(24);

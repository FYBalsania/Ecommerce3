...
public class ProductGroupConfiguration : IEntityTypeConfiguration<ProductGroup>
{
    public void Configure(EntityTypeBuilder<ProductGroup> builder)
    {
        ...
        builder.HasIndex(x => x.CreatedAt).HasDatabaseName($"idx_product_group_created_at");
        builder.HasIndex(x => x.DeletedAt).HasDatabaseName($"idx_product_group_deleted_at");

...
public class SalesOrderConfiguration : IEntityTypeConfiguration<SalesOrder>
{
    public void Configure(EntityTypeBuilder<SalesOrder> builder)
    {
        ...
        // builder.Property<CustomerReference>(x => x.CustomerReference).HasColumnType("jsonb").HasColumnOrder(6);
        builder.Property(x => x.BillingCustomerAddressId).HasColumnType("integer").HasColumnOrder(7);
        // builder.Property<CustomerAddressReference>(x => x.BillingAddressReference).HasColumnType("jsonb")
        //     .HasColumnOrder(8);
        builder.Property(x => x.ShippingCustomerAddressId).HasColumnType("integer").HasColumnOrder(9);
        // builder.Property<CustomerAddressReference>(x => x.ShippingAddressReference).HasColumnType("jsonb")
        //     .HasColumnOrder(10);
        ...
        builder.HasOne(x => (AppUser?)x.UpdatedByUser)
            .WithMany()
            .HasForeignKey(x => x.UpdatedByUser)
            .OnDelete(DeleteBehavior.Restrict);

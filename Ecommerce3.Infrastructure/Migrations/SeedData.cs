    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData("Page",
            [
                ...
                "IsActive", "created_by", "created_at", "created_by_ip"
            ],
            ["/", "Page", "SpiceMart", 0.80, "Weekly", true, "en", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")]);

        //Unit of Measures.
        migrationBuilder.InsertData(
            "UnitOfMeasure",
            [
                "Id", "Code", "Name", "Type", "BaseId", "ConversionFactor", "IsActive", "created_by", "created_at",
                "created_by_ip"
            ],
            new object[,]
            {
                { 1, "g", "Gram", nameof(UnitOfMeasureType.Weight), null, 1, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 2, "kg", "Kilogram", nameof(UnitOfMeasureType.Weight), 1, 1000, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 3, "pc", "Piece", nameof(UnitOfMeasureType.Count), null, 1, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 4, "pack", "Pack of 3", nameof(UnitOfMeasureType.Count), 3, 3, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") }
            });
        ...
        migrationBuilder.InsertData(
            ...
            [
                ...
                "IsActive", "SortOrder", "created_by", "created_at", "created_by_ip"
            ],
            new object[,]
            {
                { 1, "Same Day Delivery", "Hour", 0, 24, 0m, 1m, true, 1, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 2, "Next Day Delivery", "Day", 1, 1, 1m, 1m, true, 2, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 3, "2-3 Days Delivery", "Day", 2, 3, 2m, 3m, true, 3, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 4, "4-5 Days Delivery", "Day", 4, 5, 4m, 5m, true, 4, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 5, "Standard (1 Week)", "Day", 5, 7, 5m, 7m, true, 5, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 6, "Express (2-3 Hours)", "Hour", 2, 3, 0.1m, 0.2m, true, 6, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 7, "Scheduled (2 Weeks)", "Day", 14, 14, 14m, 14m, true, 7, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 8, "Bulk Order Delivery", "Day", 7, 14, 7m, 14m, true, 8, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 9, "International Standard", "Day", 10, 21, 10m, 21m, true, 9, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 10, "International Express", "Day", 3, 5, 3m, 5m, true, 10, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 11, "Standard (2-3 Weeks)", "Week", 2, 3, 14m, 21m, true, 11, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 12, "Economy (3-4 Weeks)", "Week", 3, 4, 21m, 28m, true, 12, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                {
                    13, "Freight / Sea Shipping (4-6 Weeks)", "Week", 4, 6, 28m, 42m, true, 13, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                { 14, "Extended (6+ Weeks)", "Week", 6, null, 42m, null, true, 14, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") }
            });
        ...
        migrationBuilder.InsertData(
            ...
            [
                ...
                "created_by", "created_at", "created_by_ip"
            ],
            new object[,]
            {
                {
            ...
            {
                {
                    ...
                    null, "organic", true, 1, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    2, "Herbs & Spices", "herbs-spices", "Herbs & Spices", "Herbs & Spices", "Herbs & Spices",
                    "Herbs & Spices", null, null, null, null, "herbs-spices", true, 2, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    3, "Nuts & Seeds", "nuts-seeds", "Nuts & Seeds", "Nuts & Seeds", "Nuts & Seeds", "Nuts & Seeds",
                    null, null, null, null, "nuts-seeds", true, 3, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, "healthy-snacks-treats", true, 4, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, null, "personal-care-aromatherapy", true, 5, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    6, "Super Foods", "super-foods", "Super Foods", "Super Foods", "Super Foods", "Super Foods", null,
                    null, null, null, "super-foods", true, 6, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    7, "Whole Foods", "whole-foods", "Whole Foods", "Whole Foods", "Whole Foods", "Whole Foods", null,
                    null, null, null, "whole-foods", true, 7, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    8, "Baking", "baking", "Baking", "Baking", "Baking", "Baking", null, null, null, null, "baking",
                    true, 8, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    null, null, "pulses-lentils-grains", true, 10, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    11, "Miscellaneous", "miscellaneous", "Miscellaneous", "Miscellaneous", "Miscellaneous",
                    "Miscellaneous", null, null, null, null, "miscellaneous", true, 11, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    12, "Offers", "offers", "Offers", "Offers", "Offers", "Offers", null, null, null, null, "offers",
                    true, 12, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                ...
                },
                {
                    ...
                    "organic.organic-herbs-spices", true, 2, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    true, 3, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    true, 4, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    true, 5, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    18, "Organic Teas", "organic-teas", "Teas", "Organic > Teas", "Organic Teas", "Organic Teas", null,
                    null, 1, null, "organic.organic-teas", true, 6, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                }
            });
        ...
        migrationBuilder.InsertData(
            ...
            new object[,]
            {
                ...
                },
                {
                    ...
                    "GB", 88, null, 13, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    null, "en", "GB", 88, null, 15, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    "en", "GB", 88, null, 16, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    "en", "GB", 88, null, 17, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    "GB", 80, null, 4, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, "en", "GB", 80, null, 5, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    null, "en", "GB", 80, null, 9, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    "en", "GB", 75, null, 10, null, null, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
            ...
            {
                {
                    ...
                    null, null, "en", "GB", 95,
                    null, null, null, 1, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, 0.9m, "weekly", null, true,
                    null, null, "en", "GB", 95,
                    null, null, null, 2, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, 0.9m, "weekly", null, true,
                    null, null, "en", "GB", 95,
                    null, null, null, 3, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, 0.9m, "weekly", null, true,
                    null, null, "en", "GB", 95,
                    null, null, null, 4, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, 0.9m, "weekly", null, true,
                    null, null, "en", "GB", 95,
                    null, null, null, 5, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                },
                {
                    ...
                    null, null, null, 0.9m, "weekly", null, true,
                    null, null, "en", "GB", 95,
                    null, null, null, 6, null, true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1")
                }
            }
        );
        ...
        // Product Category
         migrationBuilder.InsertData(
             "ProductCategory",
             ["Id", "ProductId", "CategoryId", "IsPrimary", "SortOrder", "created_by", "created_at", "created_by_ip"],
             new object[,]
             {
                 { 1, 1, 2, true, 1, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 2, 2, 2, true, 2, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 3, 3, 2, true, 3, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 4, 4, 2, true, 4, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 5, 5, 2, true, 5, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 6, 6, 2, true, 6, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 7, 7, 2, true, 7, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 8, 8, 2, true, 8, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 9, 9, 2, true, 9, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 10, 10, 2, true, 10, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 11, 11, 2, true, 11, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 12, 12, 2, true, 12, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 13, 13, 3, true, 13, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 14, 14, 3, true, 14, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 15, 15, 3, true, 15, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 16, 16, 3, true, 16, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 17, 17, 3, true, 17, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 18, 18, 3, true, 18, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 19, 19, 3, true, 19, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 20, 20, 3, true, 20, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 21, 21, 3, true, 21, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 22, 22, 3, true, 22, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 23, 23, 3, true, 23, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 24, 24, 3, true, 24, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 25, 25, 4, true, 25, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 26, 26, 4, true, 26, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 27, 27, 4, true, 27, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 28, 28, 4, true, 28, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 29, 29, 4, true, 29, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 30, 30, 4, true, 30, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 31, 31, 4, true, 31, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 32, 32, 4, true, 32, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 33, 33, 4, true, 33, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 34, 34, 4, true, 34, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 35, 35, 4, true, 35, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                 { 36, 36, 4, true, 36, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
             });

        // ImageType
        migrationBuilder.InsertData(
            "ImageType",
            ["Id", "Entity", "Name", "Slug", "Description", "IsActive", "created_by", "created_at", "created_by_ip"],
            new object[,]
            {
                {
                ...
                { 3, nameof(Page), "Banner", "banner", "Page banner", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
            });

        // Bank
        migrationBuilder.InsertData(
            "Bank",
            ["Id", "Name", "Slug", "IsActive", "SortOrder", "created_by", "created_at", "created_by_ip"],
            new object[,]
            {
                { 1, "State Bank of India", "state-bank-of-india", true, 1, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 2, "HDFC Bank", "hdfc-bank", true, 2, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 3, "ICICI Bank", "icici-bank", true, 3, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 4, "Axis Bank", "axis-bank", true, 4, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 5, "Punjab National Bank", "punjab-national-bank", true, 5, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 6, "Kotak Mahindra Bank", "kotak-mahindra-bank", true, 6, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 7, "Bank of Baroda", "bank-of-baroda", true, 7, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 8, "Canara Bank", "canara-bank", true, 8, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 9, "Union Bank of India", "union-bank-of-india", true, 9, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 10, "IndusInd Bank", "indusind-bank", true, 10, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") }
            });

        // Post Code
        migrationBuilder.InsertData(
            "PostCode",
            ["Id", "Code", "IsActive", "created_by", "created_at", "created_by_ip"],
            new object[,]
            {
                { 1, "400001", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 2, "400002", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 3, "400003", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 4, "400004", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 5, "400005", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 6, "400006", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 7, "400007", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 8, "400008", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 9, "400009", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") },
                { 10, "400010", true, 1, DateTime.Now, IPAddress.Parse("127.0.0.1") }
            });
    }

...
public partial class SeedData : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData("Page",
            ...
            [
                "/", "Page", "SpiceMart", 0.80, "Weekly", true, "en", true, 1, DateTime.Now,
        ...
        migrationBuilder.InsertData(
            ...
            {
                {
                    1, "Same Day Delivery", "Hour", 0, 24, 0m, 1m, true, 1, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                ...
                {
                    6, "Express (2-3 Hours)", "Hour", 2, 3, 0.1m, 0.2m, true, 6, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    7, "Scheduled (2 Weeks)", "Day", 14, 14, 14m, 14m, true, 7, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    8, "Bulk Order Delivery", "Day", 7, 14, 7m, 14m, true, 8, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    9, "International Standard", "Day", 10, 21, 10m, 21m, true, 9, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    10, "International Express", "Day", 3, 5, 3m, 5m, true, 10, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    11, "Standard (2-3 Weeks)", "Week", 2, 3, 14m, 21m, true, 11, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    12, "Economy (3-4 Weeks)", "Week", 3, 4, 21m, 28m, true, 12, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                {
                    14, "Extended (6+ Weeks)", "Week", 6, null, 42m, null, true, 14, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                }
            });
        ...
        migrationBuilder.InsertData(
            ...
            new object[,]
            {
                ...
                },
                {
                    ...
                    "Herbs & Spices", null, null, null, null, "herbs-spices", true, 2, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    null, null, null, null, "personal-care-aromatherapy", true, 5, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                ...
                },
                {
                    ...
                    "Miscellaneous", null, null, null, null, "miscellaneous", true, 11, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
        ...
        migrationBuilder.InsertData(
            ...
            new object[,]
            {
                ...
                },
                {
                    ...
                    null, "en", "GB", 88, null, 15, null, null, null, true, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
        ...
        migrationBuilder.InsertData(
            ...
            new object[,]
            {
                ...
                {
                    3, nameof(Page), "Banner", "banner", "Page banner", true, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
            });
        ...
        migrationBuilder.InsertData(
            ...
            {
                {
                    1, "State Bank of India", "state-bank-of-india", true, 1, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                ...
                {
                    5, "Punjab National Bank", "punjab-national-bank", true, 5, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                {
                    6, "Kotak Mahindra Bank", "kotak-mahindra-bank", true, 6, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },
                ...
                {
                    9, "Union Bank of India", "union-bank-of-india", true, 9, 1, DateTime.Now,
                    IPAddress.Parse("127.0.0.1")
                },

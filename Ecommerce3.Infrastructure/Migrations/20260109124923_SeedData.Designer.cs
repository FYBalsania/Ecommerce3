...
namespace Ecommerce3.Infrastructure.Migrations
{
    ...
    [Migration("20260109124923_SeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce3.Domain.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("idx_country_created_at");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("DeletedAt")
                        .HasDatabaseName("idx_country_deleted_at");

                    b.HasIndex("DeletedBy");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("idx_country_is_active");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("idx_country_name");

                    b.HasIndex("SortOrder")
                        .HasDatabaseName("idx_country_sort_order");
            ...
            modelBuilder.Entity("Ecommerce3.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("QuantityPerUnitOfMeasure")
                        .HasDatabaseName("IX_Product_QuantityPerUnitOfMeasure");
            ...
            modelBuilder.Entity("Ecommerce3.Domain.Entities.ProductProductAttribute", b =>
                {
                    ...
                    b.HasIndex("ProductId", "ProductAttributeId", "ProductAttributeValueId", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("UK_ProductProductAttribute_ProductId_ProductAttributeId_ProductAttributeValueId_DeletedAt");
            ...
            modelBuilder.Entity("Ecommerce3.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Ecommerce3.Domain.Entities.Country", "CountryOfOrigin")
                        .WithMany()
                    ...
                    b.HasOne("Ecommerce3.Domain.Entities.UnitOfMeasure", "UnitOfMeasure")
                        .WithMany()

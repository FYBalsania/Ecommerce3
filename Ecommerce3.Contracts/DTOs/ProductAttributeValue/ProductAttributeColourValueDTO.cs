...
public record ProductAttributeColourValueDTO : ProductAttributeValueDTO
{
    ...
    public ProductAttributeColourValueDTO(int id, string value, string slug, string display, string breadcrumb, int sortOrder, string createdUserFullName, DateTime createdAt, string? hexCode, string colourFamily, string? colourFamilyHexCode) 

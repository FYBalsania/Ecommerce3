...
public record ProductAttributeDateOnlyValueDTO : ProductAttributeValueDTO
{
    ...
    public ProductAttributeDateOnlyValueDTO(int id, string value, string slug, string display, string breadcrumb,
        decimal sortOrder, string createdUserFullName, DateTime createdAt, DateOnly dateOnlyValue)
